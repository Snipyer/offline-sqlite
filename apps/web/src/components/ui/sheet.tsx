...
function SheetOverlay({ className, ...props }: SheetPrimitive.Backdrop.Props) {
	return (
		<SheetPrimitive.Backdrop
			...
			className={cn(
				`fixed inset-0 z-50 bg-black/10 text-xs/relaxed transition-opacity duration-150
		...
		<SheetPortal>
			...
			<SheetPrimitive.Popup
				...
				className={cn(
					...
					transition duration-200 ease-in-out data-ending-style:opacity-0
					...
					data-[side=bottom]:data-starting-style:translate-y-10 data-[side=left]:inset-y-0
					data-[side=left]:left-0 data-[side=left]:h-full data-[side=left]:w-3/4
					data-[side=left]:border-r data-[side=left]:data-ending-style:-translate-x-10
					...
					data-[side=top]:data-starting-style:-translate-y-10 data-[side=left]:sm:max-w-sm
