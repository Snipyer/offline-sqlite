	...
	return (
		<SelectPrimitive.Trigger
			...
			className={cn(
				...
				dark:aria-invalid:border-destructive/50 flex w-fit items-center justify-between gap-1.5
				rounded-none border bg-transparent py-2 ps-2.5 pe-2 text-xs whitespace-nowrap
				transition-colors outline-none select-none focus-visible:ring-1 disabled:cursor-not-allowed
				disabled:opacity-50 aria-invalid:ring-1 data-[size=default]:h-8 data-[size=sm]:h-7
				data-[size=sm]:rounded-none *:data-[slot=select-value]:line-clamp-1
			...
			>
				<SelectPrimitive.Popup
					...
					className={cn(
						...
						data-open:zoom-in-95 data-[side=bottom]:slide-in-from-top-2
						data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2
						data-[side=top]:slide-in-from-bottom-2 ring-foreground/10
						data-[side=inline-start]:slide-in-from-end-2
						data-[side=inline-end]:slide-in-from-start-2 relative isolate z-50
						max-h-(--available-height) w-(--anchor-width) min-w-36 origin-(--transform-origin)
						overflow-x-hidden overflow-y-auto rounded-none shadow-md ring-1 duration-100
	...
	return (
		<SelectPrimitive.Item
			...
			className={cn(
				...
				cursor-default items-center gap-2 rounded-none py-2 ps-2 pe-8 text-xs outline-hidden
